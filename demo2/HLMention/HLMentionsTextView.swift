...
open class HLMentionsTextView: UITextView {
    ...
    weak public var hlDelegate: HLMentionsTextViewDelegate?
    
    //HL Search offline data
    public var kListMentionInfos: [HLMentionInfo]?
...
//    var kMentionLastEditLocation: Int = 0
    ...
    public func hlInsertMentionInfo(mentionInfo: HLMentionInfo,at range: NSRange) {
