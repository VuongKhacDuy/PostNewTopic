...
class EditorDemoController: UIViewController {    
    ...
    private func setupRichTextView(_ textView: TextView) {
        ...
        textView.kListMentionInfos = kMentionInfos
    }
...
extension EditorDemoController: HLMentionsTextViewDelegate {
...
extension EditorDemoController : UITextViewDelegate {
    ...
    func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        if textView == richTextView {
            return self.richTextView.hlTextView(textView, shouldChangeTextIn: range, replacementText: text)
        }
        return true
    }
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        case richTextView:
            updateFormatBar()
            richTextView.hlTextViewDidChange(textView)
        case titleTextView:
            updateTitleHeight()
        default:
            break
...
extension EditorDemoController {
    func handleAction(for barItem: FormatBarItem) {
        ...
        //        let formattingIdentifier = FormattingIdentifier("tagUser")
    ...
    func createToolbar() -> Aztec.FormatBar {
        ...
        toolbar.overflowToggleIcon = UIImage(named: "ellipsis")
...
extension FormattingIdentifier {
    ...
    private func gridicon(_ gridiconTypeA: GridiconType) -> UIImage {
        let size = EditorDemoController.Constants.formatBarIconSize
        return .gridicon(gridiconTypeA, size: size)
    }
